...
impl ResourceStore {
    ...
    pub fn remove_by_handle(&mut self, mem: &mut Memory, handle: u32) {
        if let Some(((ty, id), _)) = self.loaded.iter().find(|(_, h)| **h == handle) {
            let (ty, id) = (*ty, *id);
            self.entries
                .retain(|e| !(e.res_type == ty && e.id == id));
...
fn build_us_table() -> [u8; 128] {
    ...
    let pairs: &[(u8, u8)] = &[
        (0x00, b'a'), (0x01, b's'), (0x02, b'd'), (0x03, b'f'),
        (0x04, b'h'), (0x05, b'g'), (0x06, b'z'), (0x07, b'x'),
        (0x08, b'c'), (0x09, b'v'), (0x0B, b'b'), (0x0C, b'q'),
        (0x0D, b'w'), (0x0E, b'e'), (0x0F, b'r'), (0x10, b'y'),
        (0x11, b't'), (0x12, b'1'), (0x13, b'2'), (0x14, b'3'),
        (0x15, b'4'), (0x16, b'6'), (0x17, b'5'), (0x18, b'='),
        (0x19, b'9'), (0x1A, b'7'), (0x1B, b'-'), (0x1C, b'8'),
        (0x1D, b'0'), (0x1E, b']'), (0x1F, b'o'), (0x20, b'u'),
        (0x21, b'['), (0x22, b'i'), (0x23, b'p'), (0x24, 0x0D),
        (0x25, b'l'), (0x26, b'j'), (0x27, b'\''), (0x28, b'k'),
        (0x29, b';'), (0x2A, b'\\'), (0x2B, b','), (0x2C, b'/'),
        (0x2D, b'n'), (0x2E, b'm'), (0x2F, b'.'), (0x30, 0x09),
        (0x31, b' '), (0x32, b'`'), (0x33, 0x08), (0x34, 0x03),
        (0x35, 0x1B),
        // Keypad.
        (0x41, b'.'), (0x43, b'*'), (0x45, b'+'), (0x47, 0x1B),
        (0x4B, b'/'), (0x4C, 0x03), (0x4E, b'-'), (0x51, b'='),
        (0x52, b'0'), (0x53, b'1'), (0x54, b'2'), (0x55, b'3'),
        (0x56, b'4'), (0x57, b'5'), (0x58, b'6'), (0x59, b'7'),
        (0x5B, b'8'), (0x5C, b'9'),
        // Arrows, as the classic control characters.
        (0x7B, 0x1C), (0x7C, 0x1D), (0x7E, 0x1E), (0x7D, 0x1F),
    ];
