...
//! Dark 2.0x disk call `_Random`, and Lunatic Fringe's enemy spawning runs on
//! it. Because Apple *documented* the algorithm, this is one of the
...
mod tests {
    ...
    fn seed_zero_does_not_stick() {
        ...
        assert_ne!(
            s, 0,
            "0 is a fixed point of the recurrence and must be avoided"
        );
